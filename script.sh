...
code Tp linux
Spam
Borel Wamba <wambaforestin@gmail.com>
Pièces jointes
15:25 (il y a 4 minutes)
À moi

Pourquoi ce message figure-t-il dans les spams ? Il est semblable à des messages antérieurs identifiés comme des spams.
...
script.sh
Affichage de script.sh en cours...